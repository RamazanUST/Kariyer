<%@ Page Title="" Language="C#" MasterPageFile="~/Master/IsArayan.Master" AutoEventWireup="true" CodeBehind="Iletisim.aspx.cs" Inherits="Kariyer.IsArayan.Iletisim" %>
    ...
    <uc1:CvDuzenle runat="server" ID="CvDuzenle" />
        ...
        <div class="col-md-6">
            <div class="heading style-3 sm">
                <h3>Özgeçmiş Düzenle<span class="main-color"> / İletişim Bilgileri</span></h3>
            </div>
        </div>
        <div class="col-md-6 text-right">
            <a href="Egitim.aspx" class="main-color" style="cursor: pointer;"><i class="fa fa-share"></i>&nbsp; Sonraki Adıma Geç</a>
        </div>
    </div>
